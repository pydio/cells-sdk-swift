...
# **listNamespaceValues**
```swift
    open class func listNamespaceValues(namespace: String, operationOperation: OperationOperation_listNamespaceValues? = nil, operationValues: [String]? = nil, completion: @escaping (_ data: RestNamespaceValuesResponse?, _ error: Error?) -> Void)
```
...
let operationOperation = "operationOperation_example" // String |  (optional) (default to .put)
let operationValues = ["inner_example"] // [String] |  (optional)
 ...
 **operationOperation** | **String** |  | [optional] [default to .put]
 **operationValues** | [**[String]**](String.md) |  | [optional] 
